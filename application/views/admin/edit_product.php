				...
				<?= form_open_multipart('admin/products/update/' . $id, ['class'=>'form-horizontal']) ?>
					  ...
					  <div class="flex-w flex-sb-m form-group">
						...
						<div class="col-sm-10 w-size20">
						  <input type="text" class="form-control" style="border-bottom: 1px solid #e5e5e5 !important;" name="name" placeholder="" value="<?= $name?>">
						</div>
					  </div>
					  ...
					  <div class="flex-w flex-sb-m form-group">
						...
						<div class="col-sm-10 w-size20">
						  <input type="text" class="form-control" style="border-bottom: 1px solid #e5e5e5 !important;" name="price" placeholder="" value="<?= $price ?>">
						</div>
					  </div>
					  ...
					  <div class="flex-w flex-sb-m form-group">
						...
						<div class="col-sm-10 w-size20">
						  <input type="text" class="form-control" style="border-bottom: 1px solid #e5e5e5 !important;" name="stock" placeholder="" value="<?= $stock ?>">
						</div>
					  </div>
					  ...
					  <div class="flex-w flex-sb-m form-group">
						...
						<div class="col-sm-10 w-size20">
						  <input type="text" class="form-control" style="border-bottom: 1px solid #e5e5e5 !important;" name="weight" placeholder="" value="<?= $weight ?>">
						</div>
					  </div>
