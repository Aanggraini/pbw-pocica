...
<body class="animsition">
	...
	<section class="bgwhite p-t-55 p-b-65">
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6 p-b-50" style="margin-left: auto; margin-right: auto;">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden m-b-18">
							...
							<div class="header-cart-buttons m-t-20">
								...
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="<?php echo base_url();?>login" class="flex-c-m size1 bg7 bo-rad-20 hov1 s-text14 trans-0-4">
										Log In
									</a>
								</div>
							</div>
